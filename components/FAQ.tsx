    ...
    const faqs = [
        {
            ...
            answer: "Мы генерируем трафик через контекстную рекламу, SEO и посевы в Telegram каналах по недвижимости. Каждый лид проходит двухэтапную проверку: автоматический скоринг на дубли/спам и ручной прозвон оператором колл-центра для подтверждения бюджета и интереса.",
            icon: <RectangleStackIcon className="w-6 h-6 text-indigo-500" />
        },
        {
            question: "Вы продаете лиды в одни руки?",
            answer: "Да, это наше ключевое правило. Один верифицированный лид передается строго одному партнеру (брокеру или агентству). Мы не создаем искусственную конкуренцию на одном клиенте.",
            icon: <ShieldCheckIcon className="w-6 h-6 text-purple-500" />
        },
        {
            question: "Как быстро я получу контакт после заявки клиента?",
            answer: "Передача происходит в режиме реального времени. Как только оператор колл-центра ставит статус 'Квалифицирован', лид мгновенно отправляется в вашу CRM или Telegram-бот.",
            icon: <ClockIcon className="w-6 h-6 text-blue-500" />
        },
        {
            question: "Какие ниши и регионы доступны?",
            answer: "Мы специализируемся на жилой недвижимости (Новостройки, Вторичка) классов Бизнес, Премиум и Элит. Основные регионы: Москва, Санкт-Петербург, Сочи, Дубай, Бали. Возможен запуск под ваш регион.",
            icon: <BanknotesIcon className="w-6 h-6 text-teal-500" />
        },
        {
            question: "Есть ли интеграция с CRM?",
            answer: "Да, у нас готовы интеграции с AmoCRM и Bitrix24. Лиды падают сразу в воронку продаж. Также возможна отправка уведомлений в Telegram или на Email.",
            icon: <WrenchScrewdriverIcon className="w-6 h-6 text-orange-500" />
        },
        {
            question: "Что делать, если лид окажется некачественным?",
            answer: "Мы предоставляем гарантию замены (брак). Если контакт не соответствует заявленным критериям (недозвон более 3 раз, не тот регион, нет бюджета), мы бесплатно заменим его на новый.",
